import { version, unref, inject, getCurrentInstance, ref, computed, defineComponent, provide, shallowReactive, h, watch, Suspense, nextTick, Fragment, Transition, useSSRContext, createApp, effectScope, reactive, getCurrentScope, hasInjectionContext, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, defineAsyncComponent, mergeProps, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw } from 'vue';
...
const _routes = [
  {
    name: "home",
    path: "/home",
    component: () => import('./home-CQW1HNsU.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-DBQb1YtD.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-45qIatxt.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-BdshUnzu.mjs').then((r) => r.default || r));
...
export { navigateTo as a, useRuntimeConfig as b, resolveUnrefHeadInput as c, isNumber as d, entry$1 as default, isStringNumber as e, debugWarn as f, isBoolean as g, useGetDerivedNamespace as h, injectHead as i, useIdInjection as j, useNamespace as k, isUndefined as l, useZIndex as m, nuxtLinkDefaults as n, useId as o, resolveRouteObject as r, useRouter as u };
